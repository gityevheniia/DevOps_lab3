% devops-lab3(SECTION) | User Commands
%
% "December  8 2024"
...
devops-lab3 - program to do something

# SYNOPSIS

**devops-lab3** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**devops-lab3** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **devops-lab3** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**devops-lab3** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    devops-lab3. See **foo.conf**(5) for further details.
...
**devops-lab3** provides some return codes, that can be used in scripts:
...
yevheniia <bukhalo.yevheniia@lll.kpi.ua>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 yevheniia
